...
const Connection = async (username, password) => {
  ...
  const URL = `mongodb://{username}:{password}@ac-cybeavq-shard-00-00.futllgp.mongodb.net:27017,ac-cybeavq-shard-00-01.futllgp.mongodb.net:27017,ac-cybeavq-shard-00-02.futllgp.mongodb.net:27017/PROJECT 0?ssl=true&replicaSet=atlas-c291yr-shard-0&authSource=admin&retryWrites=true&w=majority`;
  try {
